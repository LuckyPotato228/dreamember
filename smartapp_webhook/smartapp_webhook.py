...
def handle_smartapp():
    ...
    if text in activation_phrases:
        ...
        register_url = f"https://dreamember.onrender.com/"

        msg = (
            "Привет! Я «Дримембер» — дневник снов.\n\n"
            "Чтобы сохранить сон, сначала свяжите колонку с личным кабинетом.\n"
            "Перейдите по ссылке и нажмите «Регистрация» — "
            "ID колонки подставится автоматически:\n"
            f"{register_url}\n\n"
            "Зачем это нужно?\n"
            "• ID позволяет отличать ваши записи от записей других пользователей.\n"
            "• На сайте вы сможете читать, редактировать и удалять свои сны.\n\n"
